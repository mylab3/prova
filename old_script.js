document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderFarmaciaPage() {
        ...
        if (user) {
            ...
            try { JsBarcode("#codice-fiscale-barcode", user.codiceFiscale, { format: "CODE39", height: 160, width: 10, displayValue: true, fontSize: 16 }); } catch (e) { console.error("Errore barcode CF:", e); }
    ...
    function renderRicetta() {
        ...
        if (activeRicette.length > 0) {
            ...
            try {
                JsBarcode("#nre-barcode-1", ricetta.code.substring(0, 5), { format: "CODE39", height: 60, displayValue: true, fontSize: 18 });
                JsBarcode("#nre-barcode-2", ricetta.code.substring(5), { format: "CODE39", height: 60, displayValue: true, fontSize: 18 });
