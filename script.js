document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderFarmaciaPage() {
        ...
        if (user) {
            ...
            try { JsBarcode("#codice-fiscale-barcode", user.codiceFiscale, { format: "CODE39", height: 65, displayValue: true, fontSize: 16 }); } catch (e) { console.error("Errore barcode CF:", e); }
